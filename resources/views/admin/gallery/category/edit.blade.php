...
@section('content')
    ...
    {!! Form::open(['url' => route('admin_gallery_category_update', ['id' => $category->id]), 'method' => 'post', 'class' => 'form-horizontal']) !!}
                ...
                <div class="col-md-12">
                    <fieldset class="content-group">
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <input type="text" name="title" value="{{ old('title') ? old('title') : $category->title }}" class="form-control" placeholder="Enter Title">
                                @if($errors->has('title'))
